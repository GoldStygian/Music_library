...
file_path = r"C:\Users\prora\Desktop\Geolier - EL PIBE DE ORO.mp3"#r"C:\Users\prora\Desktop\Music_library\server\media\Don Omar\Don Omar - Virtual Diva.mp3"
# json_metadata = identify_track(file_path)

print(get_acoustic_id(file_path))
